...
use ibc_testkit::testapp::ibc::core::types::GenericMockContext;
use test_log::test;
...
fn conn_open_try_fixture(ctx_variant: Ctx, msg_variant: Msg) -> Fixture<MsgConnectionOpenTry> {
    ...
    let ctx_new = GenericMockContext::new(
    ...
    let ctx = match ctx_variant {
        Ctx::Default => GenericMockContext::default(),
